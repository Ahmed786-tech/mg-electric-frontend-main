...
export function PhoneContact() {
  return (
    <div
      className="
        flex items-center justify-center gap-3 md:gap-4 self-center mt-7
        w-[220px] md:w-[256px] h-[65px] md:h-[73px] max-w-full 
        p-2 md:p-2.5 border-2 border-sky-500 border-solid rounded-[50px]
    ...
    >
      <img
        ...
        alt="Phone icon"
        className="object-contain w-7 md:w-9 rounded-[10px] aspect-[1.03]"
      />
      <div className="flex flex-col text-center sm:text-left">
        <div className="text-[14px] md:text-[16px] font-medium leading-none text-[#9D9797]">
          free consultation
        </div>
        <a
