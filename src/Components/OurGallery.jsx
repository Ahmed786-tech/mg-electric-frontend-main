...
import bg from '../assets/images/Bg11.png';
...
function OurGallery() {
  return (
    <section
      className="w-full py-16 px-4 sm:px-6 md:px-10 lg:px-20"
      style={{
    ...
    >
      <div className="max-w-7xl mx-auto text-center">
        {/* Section Header */}
        <p className="text-[#01B8FF] text-[18px] sm:text-[20px] font-normal font-andika mb-2">Gallery</p>
        <h2 className="text-white text-[32px] sm:text-[36px] md:text-[40px] font-bold font-andika mb-12">Our Gallery</h2>

        {/* Gallery Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-12 justify-items-center">
          {galleryImages.map((image, index) => (
            <div key={index} className="overflow-hidden rounded-[20px] w-full max-w-[401px]">
              <img
                src={image}
                alt={`Image ${index + 1}`}
